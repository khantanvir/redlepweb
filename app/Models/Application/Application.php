...
class Application extends Model
{
    ...
    public $sortable = ['id','first_name','last_name','email','phone','gender','date_of_birth','intake','created_at'];
    ...
    public function interview_status_data(){
        return $this->belongsTo(InterviewStatus::class,'interview_status','id');
    }
}
